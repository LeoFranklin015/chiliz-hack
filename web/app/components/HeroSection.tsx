        ...
        <div className="relative h-full">
          ...
          <div className="absolute right-8 bottom-0 w-96 h-full bg-gradient-to-t from-blue-600/30 to-transparent rounded-l-3xl">
            <div className="absolute bottom-20 right-8 text-right text-white">
              ...
              <div className="text-lg opacity-80">Fantasy Sports Revolution</div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-12 gap-6">
          ...
          <div className="col-span-8 space-y-8">
            ...
            >
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-sm text-gray-400">{gameModes[0].modes}</span>
              </div>
              ...
              <div className="grid grid-cols-3 gap-4">
                {gameModes.map((mode, index) => (
                  <motion.div
                    ...
                    className={`relative ${mode.image} rounded-xl overflow-hidden cursor-pointer group transition-all duration-300 hover:scale-105 ${
                  ...
                  >
                    ...
                    <div className="relative p-6 h-full flex flex-col justify-end">
                      <div className="mb-2">
                        {mode.subtitle && (
                          <div className="text-xs text-white/80 mb-1">{mode.subtitle}</div>
                        )}
                ...
                {advancedModes.map((mode, index) => (
                  ...
                  >
                    ...
                    <div className="relative p-4 h-full flex flex-col justify-end">
                      <h3 className="text-sm font-black text-white">{mode.title}</h3>
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-2xl font-black text-white">ULTIMATE TEAM</h2>
              ...
              <div className="grid grid-cols-4 gap-3">
                {ultimateTeamModes.map((mode, index) => (
                  ...
                  >
                    ...
                    <div className="relative p-3 h-full flex flex-col justify-end">
                      <h3 className="text-xs font-bold text-white">{mode.title}</h3>
                ...
                >
                  <div className="absolute inset-0 bg-black/40 group-hover:bg-black/30 transition-colors" />
                  <div className="relative p-3 h-full flex flex-col justify-end">
                    <h3 className="text-xs font-bold text-white">CAREER MODE</h3>
          ...
          <div className="col-span-4">
            ...
            >
              ...
              {/* Featured player */}
              <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-600 rounded-xl p-6">
                <h3 className="text-lg font-bold text-white mb-4">Featured Player</h3>
                <div className="text-center">
                  ...
                  <div className="mt-3 text-green-400 font-bold">€1,247 CHZ</div>
