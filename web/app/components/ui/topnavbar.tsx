...
export default function TopNav() {
  ...
  const handleMint = () => {
    ...
    setTimeout(() => setMintLoading(false), 1500);
  };
        ...
        >
          <div className=" flex items-center justify-between">
            ...
            <div className="flex items-center space-x-0">
              ...
              {/* Faucet Button */}
              <Button
                className="ml-4 bg-[linear-gradient(90deg,rgba(207,10,10,0.2)_0%,rgba(207,10,10,0.4)_100%)] text-[#cf0a0a] font-bold px-4 py-2 rounded-xl shadow-lg hover:bg-[linear-gradient(90deg,rgba(207,10,10,0.4)_0%,rgba(207,10,10,0.6)_100%)] hover:text-white transition-all duration-300 border border-[#cf0a0a]"
