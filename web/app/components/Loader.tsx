...
export default function SvgLoader({
  ...
  const LoaderSvg = () => (
    <div className={cn("flex items-center justify-center", className)}>
      ...
      >
        <path
          className="animate-pulse-custom fill-emerald-500 [animation-delay:-125ms]"
        ...
        />
        <path
          className="animate-pulse-custom fill-emerald-500 [animation-delay:-250ms]"
          d="M97.55,38.68A43.76,43.76,0,0,1,98,33.44c.41-2.36-.5-3.57-2.57-4.64C91.1,26.59,87,24,82.66,21.82a6.18,6.18,0,0,0-4-.71C73.45,22.55,68.32,24.25,63.22,26c-3.63,1.21-6.08,3.35-5.76,7.69a26.67,26.67,0,0,1-.6,4.92c-1.08,8.06-1.08,8.08,5.86,11.92,3.95,2.19,7.82,5.75,11.94,6.08s8.76-2.41,13.12-3.93c9.33-3.29,9.33-3.3,9.78-14Z"
        />
        <path
          className="animate-pulse-custom fill-emerald-500 [animation-delay:-375ms]"
        ...
        />
        <path
          className="animate-pulse-custom fill-emerald-500 [animation-delay:-500ms]"
        ...
        />
        <path
          className="animate-pulse-custom fill-emerald-500 [animation-delay:-625ms]"
        ...
        />
        <path
          className="animate-pulse-custom fill-emerald-500 [animation-delay:-750ms]"
        ...
        />
        <path
          className="animate-pulse-custom fill-emerald-500 [animation-delay:-875ms]"
        ...
        />
        <path
          className="animate-pulse-custom fill-emerald-500 [animation-delay:-1000ms]"
          d="M66.28,132.51c13.36,3.78,25.62,3.5,38-.9C91.68,129.59,79.36,128,66.28,132.51Z"
        />
        <path
          className="animate-pulse-custom fill-emerald-500 [animation-delay:-1125ms]"
        ...
        />
        <path
          className="animate-pulse-custom fill-emerald-500 [animation-delay:-1250ms]"
